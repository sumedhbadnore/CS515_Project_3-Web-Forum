...
def search_date_time():
    with lock_state:
        ...
        try:
            start_datetime = datetime.strptime(start_datetime_str, "%Y-%m-%dT%H:%M:%S.%f") if start_datetime_str else None
            end_datetime = datetime.strptime(end_datetime_str, "%Y-%m-%dT%H:%M:%S.%f") if end_datetime_str else None
            ...
            for post in all_posts:
                ...
                post_timestamp = datetime.strptime(my_post.get("timestamp"), "%Y-%m-%dT%H:%M:%S.%f")
